...
Tags: woocommerce, wpc, shoppable image, hotspot
...
To get a first-hand experience of our plugin, feel free to check out on your own on the [live demo](https://demo.wpclever.net/wpcsi/ "live demo").
...
= CREATE VIBRANT SHOPPABLE FEEDS =
...
= WPC PLUGINS THE WORK WELL WITH THIS =

- [WPC Smart Quick View for WooCommerce](https://wordpress.org/plugins/woo-smart-quick-view/ "WPC Smart Quick View for WooCommerce")
- [WPC Fly Cart for WooCommerce](https://wordpress.org/plugins/woo-fly-cart/ "WPC Fly Cart for WooCommerce")
- [WPC Countdown Timer for WooCommerce](https://wordpress.org/plugins/wpc-countdown-timer/ "WPC Countdown Timer for WooCommerce")
- [WPC AJAX Add to Cart for WooCommerce](https://wordpress.org/plugins/wpc-ajax-add-to-cart/ "WPC AJAX Add to Cart for WooCommerce")
- [WPC Added To Cart Notification for WooCommerce](https://wordpress.org/plugins/woo-added-to-cart-notification/ "WPC Added To Cart Notification for WooCommerce")

== Installation ==

1. Please make sure that you installed WooCommerce
2. Go to plugins in your dashboard and select "Add New"
3. Search for "WPC Shoppable Images", Install & Activate it
4. Go to WP-admin > Shoppable Images to add an image
5. Get the shortcode and use it where you want
...
= 2.0.0 =
* Added: Label for each hotspot

= 1.0.3 =
* Added: Ruler for each hotspot in backend

= 1.0.2 =
* Updated: Allow shortcode [wpcsi_search]

= 1.0.1 =
* Updated: Allow shortcode [wpcsi_cart]
