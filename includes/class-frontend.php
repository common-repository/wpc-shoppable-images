...
class WPCleverWpcsi_Frontend {
	...
	public function __construct() {
		...
		add_shortcode( 'wpcsi', [ $this, 'shortcode' ] );
	...
	function get_cart() {
		...
		$cart     = '<span class="wpcsi-cart" data-count="' . esc_attr( $count ) . '" data-subtotal="' . esc_attr( $subtotal ) . '"><a href="' . wc_get_cart_url() . '" class="woofc-cart"><span class="wpcsi-cart-subtotal">' . $subtotal . '</span> <span class="wpcsi-cart-count">' . sprintf( /* translators: count */ _n( '(%s item)', '(%s items)', $count, 'wpc-shoppable-images' ), number_format_i18n( $count ) ) . '</span></a></span>';
